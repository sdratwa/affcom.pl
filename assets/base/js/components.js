...
var ContentOwlcarousel = function () {
	...
	var _initInstances = function () {
		$("[data-slider='owl'] .owl-carousel2").each(function () {
			...
			var items_nav_dots = (parent.data('navigation-dots')) ? parent.data('navigation-dots') : false ;
			var items_nav_label = (parent.data('navigation-label')) ? parent.data('navigation-label') : true ;
